...
const en: Dict = {
  ...
  "events.close": "Close",
  "events.featured.body": "The full article body will appear here. Replace this placeholder with the real story, photos, outcomes and impact details from the event.",
...
const sq: Dict = {
  ...
  "events.close": "Mbyll",
  "events.featured.body": "Trupi i plotë i artikullit do të shfaqet këtu. Zëvendësojeni me historinë reale, foto, rezultate dhe detajet e ndikimit nga eventi.",
