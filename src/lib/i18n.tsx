...
const en: Dict = {
  ...
  "events.featured.title": "The Journey of 'Brandon Forever 22 Legacy' Begins: A Mission of Hope and Humanity.",
...
const sq: Dict = {
  ...
  "events.featured.title": "Nis rrugëtimi i 'Brandon Forever 22 Legacy': Një mision shprese dhe humanizmi.",
