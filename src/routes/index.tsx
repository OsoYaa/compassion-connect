  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden min-h-screen px-4 pt-20 pb-12 sm:px-6 sm:pt-28 sm:pb-24">
        <Link
          to="/"
          className="absolute left-1/2 top-20 z-20 flex -translate-x-1/2 items-center justify-center transition duration-300 hover:scale-[1.03] md:left-[5%] md:top-20 md:translate-x-0"
          aria-label="Home"
        >
          <img
            src={logo}
            alt="Logo"
            className="h-52 w-auto object-contain sm:h-60 md:h-72 lg:h-80"
          />
        </Link>
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-6rem)] w-full max-w-4xl flex-col justify-center md:mx-0 md:ml-[2%] md:max-w-[65%] md:justify-start md:pt-[14rem] lg:pt-[16rem] md:pr-8">
          {/* LEFT: text content */}
          <div className="animate-fade-up flex flex-col text-center md:text-left text-white">
            <h1 className="mt-52 font-serif text-3xl font-bold leading-[1.1] text-white sm:mt-60 sm:text-5xl md:mt-0 md:text-6xl">
              {t("hero.title")}
            </h1>
